...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, Q, K, V):
        ...
        # Call your implementation of ScaledDotProductAttention or PyTorch's version
        sdpa = ScaledDotProductAttention(self.d_k, self.dropout)
        attention_output, attention_scores = sdpa.forward(Q, K, V)
